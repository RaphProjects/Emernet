...
_default_arena = Arena(modules="Rich")
avg_learn = _default_arena.avg_learn
std_learn = _default_arena.std_learn
avg_speed = _default_arena.avg_speed
std_speed = _default_arena.std_speed
speed_bal = _default_arena.speed_bal
